...
|----------------------------------------------|-------------------------------------------------------------|
| **GET /users/{userId}**                      | Returns user's username, email and created time             |
...
| **GET /items/{itemId}**                      | Returns info about item with given ID                       |
| **POST /items**                              | Create a new item                                           |
| **GET /currency/{currencyId}**               | Returns info about currency with given ID                   |
